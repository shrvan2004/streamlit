...
st.image("Screenshot 2024-11-02 170426.png")
st.audio("file example.wav")
st.video("Screen Recording 2024-09-03 224704.mp4")
...
st.sidebar.image("Screenshot 2024-11-02 170426.png")
